  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      if (response.ok) {
        ...
        localStorage.setItem('user_fn',data.ud)
        localStorage.setItem('user_ln',data.ud1)
        localStorage.setItem('user_em',data.ud2)

        // localStorage.setItem('firstName',data.fn)
        // localStorage.setItem('lastName',data.ln)
        // localStorage.setItem('course',data.cr)
        // localStorage.setItem('selectedBranch',data.sb)
        // localStorage.setItem('trade',data.tr)
